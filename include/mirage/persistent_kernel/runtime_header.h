...
// Consumer/workstation Blackwell (SM120, e.g. RTX Pro 6000): 128KB smem per
// SM, ~99KB max per block — NOT the datacenter SM100 budget.
...
// dynamic smem per block, unlike datacenter SM100's 227KB.
constexpr int MAX_DYNAMIC_SHARED_MEMORY_SIZE =
    99 * 1024 - WORKER_RESERVED_STATIC_SHARED_MEMORY_SIZE;
#elif MPK_TARGET_CC >= 90
